...
set +x
NET_FINAL='/nfs.yoda/xiaolonw/faster_rcnn/xiaolonw/py-faster-rcnn2/output/fast_rcnn_pascal/voc3_2007_trainval/save/vgg_cnn_m_1024_fast_rcnn3_iter_80000.caffemodel'
set -x
