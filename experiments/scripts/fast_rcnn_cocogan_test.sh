...
set +x
NET_FINAL='/nfs.yoda/xiaolonw/faster_rcnn/xiaolonw/py-faster-rcnn2/output/fast_rcnn_coco/coco2_2014_train/vgg_cnn_m_1024_fast_rcnn_iter_560000.caffemodel'
set -x
